...
if diff $MY_CWD/controls_logilinkpdu8p01.txt repository/$TRAVIS_BRANCH/controls_logilinkpdu8p01.txt; then
    echo "No changes to the output $MY_CWD/controls_logilinkpdu8p01.txt repository/$TRAVIS_BRANCH/controls_logilinkpdu8p01.txt on this push; exiting."
    exit 0
fi

mkdir -p repository/$TRAVIS_BRANCH/FHEM
mv $MY_CWD/controls_logilinkpdu8p01.txt repository/$TRAVIS_BRANCH/controls_logilinkpdu8p01.txt
